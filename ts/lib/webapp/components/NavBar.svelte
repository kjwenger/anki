...
<nav
    class="sticky top-0 z-50 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 shadow-xs"
>
    <div class="max-w-7xl mx-auto px-4 flex justify-between items-center h-16">
        ...
        <div
            class="items-center {showMobileMenu
                ? 'flex absolute top-16 left-0 right-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 flex-col gap-0 p-4'
        ...
        >
            ...
            <div class="relative {showMobileMenu ? 'w-full mt-2' : ''}">
                {#if $currentUser}
                    <button
                        class="flex items-center gap-2 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded px-4 py-2 cursor-pointer text-sm transition-all duration-200 hover:bg-gray-200 dark:hover:bg-gray-700 {showMobileMenu
                    ...
                    {#if showUserMenu}
                        <div
                            class="{showMobileMenu
                                ? 'static mt-2 shadow-none border-0 bg-gray-50 dark:bg-gray-800'
                                : 'absolute top-full mt-2 right-0 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded shadow-lg'} min-w-[180px] z-50"
                        >
                            <button
