...
>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 w-full max-w-lg">
        <h1 class="m-0 mb-6 text-3xl text-gray-800 dark:text-gray-100 font-bold">
            Profile
        </h1>
        ...
        {#if $currentUser}
            ...
            {#if message}
                <div
                    class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg text-green-600 dark:text-green-400 p-3 mb-4"
                >
                    {message}
                </div>
            {/if}
            ...
            {#if error}
                <div
                    class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg text-red-600 dark:text-red-400 p-3 mb-4"
                >
                    {error}
                </div>
            {/if}
